...
import 'file:///C:/Users/bhara/AndroidStudioProjects/Success/mx_companion/lib/Shared/PageTransition.dart';
        ...
        : Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/images/backgroundStar.png"),
                  fit: BoxFit.cover),
            ),
            child: Scaffold(
                              ...
                              callback: () async {
                                ...
                                if (user == null) {
                                  ...
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => Next(user: user),
                                    ),
                                  );
                                }
                              },
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.of(context).pushReplacement(
                                    RightSlideRoute(page: RegistrationPage()));
                              },
                              child: Text(
                                ' Sign Up',
                                style: TextStyle(
